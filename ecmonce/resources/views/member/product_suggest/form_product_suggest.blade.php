<div class="form-group{{ $errors->has('product_name') ? 'has-error' : '' }}">
    {{ Form::label('product_name', trans('product.lbl-name'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group">
    {{ Form::label('position', trans('product.lbl-images'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group{{ $errors->has('price') ? 'has-error' : '' }}">
    {{ Form::label('price', trans('product.lbl-price'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group{{ $errors->has('number_current') ? 'has-error' : '' }}">
    {{ Form::label('number_current', trans('product.lbl-number'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group{{ $errors->has('made_in') ? 'has-error' : '' }}">
    {{ Form::label('made_in', trans('product.lbl-made-in'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group old-category">
    {{ Form::label('category', trans('product.lbl-category'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group div-category{{ isset($productSuggest->category_name) ? '' : ' div-category-new' }}">
    {{ Form::label('category_name', trans('product.lbl-new-parent-category'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group div-category{{ isset($productSuggest->sub_category_new) ? '' : ' div-category-new'  }}">
    {{ Form::label('sub_category_new', trans('product.lbl-new-sub-category'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group{{ $errors->has('date_manufacture') ? 'has-error' : '' }}">
    {{ Form::label('date_manufacture', trans('product.lbl-date-manufacture'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group{{ $errors->has('date_expiration') ? 'has-error' : '' }}">
    {{ Form::label('date_expiration', trans('product.lbl-date-expiration'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
...
<div class="form-group{{ $errors->has('description') ? 'has-error' : '' }}">
    {{ Form::label('description', trans('product.lbl-description'), ['class' => 'col-md-12 control-label']) }}
    <div class="col-md-12">
